...
const translations = {
  it: {
    ...
    skills: 'Competenze',
    integrationArchitecture: 'Integration Architecture', integrationArchitectureBody: 'Progetto architetture SAP BTP scalabili, sicure e manutenibili, definendo pattern, governance e connessioni tra cloud e sistemi on-premise.',
    apiProcessIntegration: 'API, B2B & Process Integration', apiProcessIntegrationBody: 'Realizzo integrazioni API-first, B2B/B2G, EDI e processi enterprise con REST, OData, SOAP, IDoc, AS2 ed EDIFACT.',
    engineeringDelivery: 'Engineering & Technical Delivery', engineeringDeliveryBody: 'Sviluppo iFlow, routing, mapping e trasformazioni con Groovy, XSLT e ABAP, curando troubleshooting, qualità del codice e delivery.',
    teamEnablement: 'Team Enablement & Internal Tooling', teamEnablementBody: 'Creo template, linee guida e strumenti per documentare tenant CPI e confrontare deploy e versioni tra ambienti.',
    ecosystemAriaLabel: 'Ecosistemi integrati', ecosystemSapLabel: 'SAP', ecosystemSap: 'BTP · S/4HANA · ECC · SuccessFactors · C4C · CPQ',
    ecosystemWmsLabel: 'WMS', ecosystemWms: 'Modula · Stockager · Kardex',
    ecosystemLabelsLabel: 'Spedizioni & Label', ecosystemLabels: 'GLS · DPD · Labelnet · NiceLabel',
    ecosystemEInvoicingLabel: 'Fatturazione elettronica', ecosystemEInvoicing: 'TeamSystem · Basware',
    ecosystemProcurementLabel: 'Procurement', ecosystemProcurement: 'Jaggaer',
    ecosystemPlmLabel: 'PLM / PIM', ecosystemPlm: 'Centric · 3DEXPERIENCE · Oracle Agile · Windchill',
    ecosystemCrmLabel: 'CRM', ecosystemCrm: 'Salesforce',
    ecosystem3plLabel: '3PL', ecosystem3pl: 'Flamesoft · Alpega · Flash',
  ...
  en: {
    ...
    skills: 'Skills',
    integrationArchitecture: 'Integration Architecture', integrationArchitectureBody: 'I design scalable, secure, and maintainable SAP BTP architectures, defining patterns, governance, and connections between cloud and on-premise systems.',
    apiProcessIntegration: 'API, B2B & Process Integration', apiProcessIntegrationBody: 'I deliver API-first, B2B/B2G, EDI, and enterprise process integrations using REST, OData, SOAP, IDoc, AS2, and EDIFACT.',
    engineeringDelivery: 'Engineering & Technical Delivery', engineeringDeliveryBody: 'I build iFlow processes, routing, mapping, and transformations with Groovy, XSLT, and ABAP, focusing on troubleshooting, code quality, and delivery.',
    teamEnablement: 'Team Enablement & Internal Tooling', teamEnablementBody: 'I create templates, guidelines, and tools to document CPI tenants and compare deployments and versions across environments.',
    ecosystemAriaLabel: 'Integrated ecosystems', ecosystemSapLabel: 'SAP', ecosystemSap: 'BTP · S/4HANA · ECC · SuccessFactors · C4C · CPQ',
    ecosystemWmsLabel: 'WMS', ecosystemWms: 'Modula · Stockager · Kardex',
    ecosystemLabelsLabel: 'Shipping & Labelling', ecosystemLabels: 'GLS · DPD · Labelnet · NiceLabel',
    ecosystemEInvoicingLabel: 'Custom e-invoicing', ecosystemEInvoicing: 'TeamSystem · Basware',
    ecosystemProcurementLabel: 'Procurement', ecosystemProcurement: 'Jaggaer',
    ecosystemPlmLabel: 'PLM / PIM', ecosystemPlm: 'Centric · 3DEXPERIENCE · Oracle Agile · Windchill',
    ecosystemCrmLabel: 'CRM', ecosystemCrm: 'Salesforce',
    ecosystem3plLabel: '3PL', ecosystem3pl: 'Flamesoft · Alpega · Flash',
