...
const translations = {
  it: {
    ...
    sapEcosystems: 'Ecosistemi SAP integrati: SAP BTP, Integration Suite, S/4HANA, ECC, SuccessFactors, SAP Sales and Service Cloud (C4C) e SAP CPQ.',
  ...
  en: {
    ...
    sapEcosystems: 'Integrated SAP ecosystems: SAP BTP, Integration Suite, S/4HANA, ECC, SuccessFactors, SAP Sales and Service Cloud (C4C), and SAP CPQ.',
